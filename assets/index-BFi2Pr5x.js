...
`;const n=document.getElementById("start-button");n&&n.addEventListener("click",()=>{window.location.href="game.html"});document.querySelector("#credits").innerHTML=`
